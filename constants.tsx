...
export const ICONS = {
  VelvetLogo: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25l-9 5.25 9 5.25 9-5.25-9-5.25z" />
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25l4.5 2.625v5.25L12 18.75l-4.5-2.625v-5.25L12 8.25z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v10.5" className="opacity-50" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.875L7.5 16.125" className="opacity-50" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 10.875l9 5.25" className="opacity-50" />
    </svg>
  ),
  ...
  Adjustments: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
